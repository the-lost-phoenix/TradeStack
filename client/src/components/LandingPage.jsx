            ...
            <div className="relative z-10">
                ...
                <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto border-b border-white/5 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                        <Icons.Logo />
                        <div>
                            <h1 className="text-3xl font-orbitron font-bold tracking-widest text-starlight">
                                TRADE<span className="text-solar-flare">STACK</span>
                            </h1>
                            <p className="text-[10px] uppercase font-bold text-gray-500 tracking-[0.3em] font-rajdhani">
                    ...
                    <div className="flex gap-4 items-center">
                        <button
                            ...
                            className="text-sm font-rajdhani font-bold text-gray-400 hover:text-solar-flare transition-colors tracking-widest uppercase hidden sm:block"
                        >
                            Log In
                        </button>
                        <button
